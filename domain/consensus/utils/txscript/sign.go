...
// SignatureScript creates an input signature script for tx to spend BGA sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend BGA sent
