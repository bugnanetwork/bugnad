/*
Package txscript implements the bugna transaction script language.

This package provides data structures and functions to parse and execute
bugna transaction scripts.

# Script Overview

Bugna transaction scripts are written in a stack-base, FORTH-like language.

The bugna script language consists of a number of opcodes which fall into
...
Typical bugna scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend bugna.
