...
func (ar AccountRef) CreateContractAddress(addr Address, nonce uint64) Address {
	contractAddr := CreateAddress((Address)(addr), nonce)
	return contractAddr
}
...
func (c *Contract) CreateContractAddress(b Address, nonce uint64) Address {
	return c.addressHandler.CreateAddress(b, nonce)
}
