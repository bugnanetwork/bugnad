...
func opSha3(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	if evm.vmConfig.EnablePreimageRecording {
		evm.StateDBHandler.AddPreimage(BytesToHash(hash), data)
	}
...
func opBalance(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	return nil, fmt.Errorf("opBalance is not supported")
	// slot := stack.peek()
	// slot.Set(evm.StateDBHandler.GetBalance(BigToAddress(slot)))
	// return nil, nil
}
...
func opExtCodeSize(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	slot := stack.peek()
	slot.SetUint64(uint64(evm.StateDBHandler.GetCodeSize(BigToAddress(slot))))
...
func opExtCodeCopy(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	codeCopy := getDataBig(evm.StateDBHandler.GetCode(addr), codeOffset, length)
	memory.Set(memOffset.Uint64(), length.Uint64(), codeCopy)
...
func opGasprice(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	return nil, fmt.Errorf("opGasprice is not supported")
...
func opBlockhash(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	return nil, fmt.Errorf("opBlockhash is not supported")
	// num := stack.pop()
	//
	// n := evm.interpreter.intPool.get().Sub(evm.BlockNumber, Big257)
	// if num.Cmp(n) > 0 && num.Cmp(evm.BlockNumber) < 0 {
	// 	stack.push(evm.chainHandler.GetBlockHeaderHash(num.Uint64()).Big())
	// } else {
...
func opCoinbase(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	return nil, fmt.Errorf("opCoinbase is not supported")
	// stack.push(evm.Coinbase.Big())
	// return nil, nil
}

func opTimestamp(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	stack.push(U256(evm.interpreter.intPool.get().Set(evm.Time)))
	return nil, nil
}

func opNumber(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	stack.push(U256(evm.interpreter.intPool.get().Set(evm.BlockNumber)))
	return nil, nil
}
...
func opSload(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	loc := stack.peek()
	val := evm.StateDBHandler.GetState(contract.Address(), BigToHash(loc))
...
func opSstore(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	val := stack.pop()
	evm.StateDBHandler.SetState(contract.Address(), loc, BigToHash(val))
...
func opSuicide(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	return nil, fmt.Errorf("opSuicide is not supported")
	// balance := evm.StateDBHandler.GetBalance(contract.Address())
	// evm.StateDBHandler.AddBalance(BigToAddress(stack.pop()), balance)

	// evm.StateDBHandler.Suicide(contract.Address())
	// return nil, nil
}
