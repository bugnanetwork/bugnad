...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := bugnad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = bugnad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = bugnad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
