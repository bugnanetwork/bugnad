...
// installService attempts to install the bugnad service. Typically this should
...
// removeService attempts to uninstall the bugnad service. Typically this should
...
// startService attempts to Start the bugnad service.
