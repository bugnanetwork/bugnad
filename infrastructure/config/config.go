...
const (
	defaultConfigFilename      = "bugnad.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "bugnad.log"
	defaultErrLogFilename      = "bugnad_err.log"
	...
	sampleConfigFilename    = "sample-bugnad.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for bugnad.
	DefaultAppDir = util.AppDir("bugnad", false)
...
// Flags defines the configuration options for bugnad.
//
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 38139, testnet: 38139)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 38138, testnet: 38238)"`
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in BGA/kB to be considered a non-zero fee."`
...
// Config defines the configuration options for bugnad.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default bugnad configuration
...
//
// The above results in bugnad functioning properly without any config settings
...
// createDefaultConfig copies the file sample-bugnad.conf to the given destination path,
