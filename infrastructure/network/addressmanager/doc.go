/*
Package addressmanager implements concurrency safe Bugna address manager.

# Address Manager Overview

In order maintain the peer-to-peer Bugna network, there needs to be a source
of addresses to connect to as nodes come and go. The Bugna protocol provides
