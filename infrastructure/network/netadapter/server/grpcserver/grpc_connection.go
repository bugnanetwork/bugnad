...
type grpcStream interface {
	Send(*protowire.BugnadMessage) error
	Recv() (*protowire.BugnadMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.BugnadMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.BugnadMessage) error {
