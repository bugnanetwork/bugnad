...
func (x *BugnadMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "BugnadMessage_Addresses is nil")
	}
...
func (x *BugnadMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
