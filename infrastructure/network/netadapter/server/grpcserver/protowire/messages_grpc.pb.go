...
type P2P_MessageStreamClient interface {
	Send(*BugnadMessage) error
	Recv() (*BugnadMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *BugnadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*BugnadMessage, error) {
	m := new(BugnadMessage)
...
func (x *p2PMessageStreamServer) Send(m *BugnadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*BugnadMessage, error) {
	m := new(BugnadMessage)
...
func (x *rPCMessageStreamClient) Send(m *BugnadMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*BugnadMessage, error) {
	m := new(BugnadMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *BugnadMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*BugnadMessage, error) {
	m := new(BugnadMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
