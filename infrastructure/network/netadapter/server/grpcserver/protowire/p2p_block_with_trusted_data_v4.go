...
func (x *BugnadMessage_BlockWithTrustedDataV4) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BugnadMessage_BlockWithTrustedDataV4 is nil")
	}
...
func (x *BugnadMessage_BlockWithTrustedDataV4) fromAppMessage(msgBlockWithTrustedData *appmessage.MsgBlockWithTrustedDataV4) error {
