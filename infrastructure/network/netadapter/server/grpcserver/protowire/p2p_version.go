...
func (x *BugnadMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BugnadMessage_Version is nil")
	}
...
func (x *BugnadMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
