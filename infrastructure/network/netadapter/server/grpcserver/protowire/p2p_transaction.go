...
func (x *BugnadMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BugnadMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *BugnadMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
