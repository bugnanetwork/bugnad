...
func (x *BugnadMessage_TrustedData) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "BugnadMessage_TrustedDataMessage is nil")
	}
...
func (x *BugnadMessage_TrustedData) fromAppMessage(msgTrustedData *appmessage.MsgTrustedData) error {
