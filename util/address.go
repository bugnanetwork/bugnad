...
const (
	...
	Bech32PrefixBugnaDev

	// Prefix for the test network.
	Bech32PrefixBugnaTest

	// Prefix for the simulation network.
	Bech32PrefixBugnaSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"bugna":     Bech32PrefixBugna,
	"bugnadev":  Bech32PrefixBugnaDev,
	"bugnatest": Bech32PrefixBugnaTest,
	"bugnasim":  Bech32PrefixBugnaSim,
}
...
// and a payload which encodes the bugna network and address type. It is used
