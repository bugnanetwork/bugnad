...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "bugna:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "bugna:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixBugna,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixBugna)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixBugna,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "bugna:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "bugna:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixBugna,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixBugna,
			expectedPrefix: util.Bech32PrefixBugna,
		},
		{
			name:    "testnet p2pk",
			addr:    "bugnatest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "bugnatest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixBugnaTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixBugnaTest)
			},
			passedPrefix:   util.Bech32PrefixBugnaTest,
			expectedPrefix: util.Bech32PrefixBugnaTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "bugna:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "bugna:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixBugna)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixBugna,
		},
		...
		},
		{
			...
			addr:           "bugna:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixBugna,
			expectedPrefix: util.Bech32PrefixBugna,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "bugna:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "bugna:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixBugna)
			},
			passedPrefix:   util.Bech32PrefixBugna,
			expectedPrefix: util.Bech32PrefixBugna,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "bugna:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "bugna:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixBugna,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixBugna)
			},
			passedPrefix:   util.Bech32PrefixBugna,
			expectedPrefix: util.Bech32PrefixBugna,
		},
		{
			name:    "testnet p2sh",
			addr:    "bugnatest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "bugnatest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixBugnaTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixBugnaTest)
			},
			passedPrefix:   util.Bech32PrefixBugnaTest,
			expectedPrefix: util.Bech32PrefixBugnaTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"bugnasim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixBugnaSim,
			"unknown address type",
		},
		{
			"bugnasim:raskzcg58mth0an",
			util.Bech32PrefixBugnaSim,
			"unknown address type",
		},
		{
			"bugnatest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixBugna,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"bugna", util.Bech32PrefixBugna, false},
		{"bugnatest", util.Bech32PrefixBugnaTest, false},
		{"bugnasim", util.Bech32PrefixBugnaSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixBugna, "bugna"},
		{util.Bech32PrefixBugnaTest, "bugnatest"},
		{util.Bech32PrefixBugnaSim, "bugnasim"},
		{util.Bech32PrefixUnknown, ""},
	}
