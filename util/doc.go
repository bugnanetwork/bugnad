...
A Block defines a bugna block that provides easier and more efficient
...
A Tx defines a bugna transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a bugna address. While the
most common type is a pay-to-pubkey, bugna already supports others and
...
To decode/encode an address:
	...
	addrString := "bugna:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixBugna
