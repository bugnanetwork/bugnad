...
// RPCTransaction is a bugnad transaction representation meant to be
// used over RPC
...
// RPCScriptPublicKey is a bugnad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a bugnad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a bugnad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a bugnad utxo entry representation meant to be used
// over RPC
