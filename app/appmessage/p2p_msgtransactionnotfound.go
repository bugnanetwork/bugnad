...
// MsgTransactionNotFound defines a bugna TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new bugna transactionsnotfound message that conforms to the
