...
// MsgRequestAnticone implements the Message interface and represents a bugna
...
// NewMsgRequestAnticone returns a new bugna RequestPastDiff message that conforms to the
