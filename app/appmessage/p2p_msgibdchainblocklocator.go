...
// MsgIBDChainBlockLocator implements the Message interface and represents a bugna
...
// NewMsgIBDChainBlockLocator returns a new bugna locator message that conforms to
