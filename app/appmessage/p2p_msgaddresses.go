...
// bugna Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a bugna
// Addresses message.
...
// NewMsgAddresses returns a new bugna Addresses message that conforms to the
