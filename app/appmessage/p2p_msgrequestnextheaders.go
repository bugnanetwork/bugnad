...
// MsgRequestNextHeaders implements the Message interface and represents a bugna
...
// NewMsgRequestNextHeaders returns a new bugna RequestNextHeaders message that conforms to the
// Message interface.
