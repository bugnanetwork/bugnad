...
var DefaultUserAgent = fmt.Sprintf("/bugnad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a bugna version
...
// NewMsgVersion returns a new bugna version message that conforms to the
