...
// MsgRequestRelayBlocks implements the Message interface and represents a bugna
...
// NewMsgRequestRelayBlocks returns a new bugna RequestRelayBlocks message that conforms to
