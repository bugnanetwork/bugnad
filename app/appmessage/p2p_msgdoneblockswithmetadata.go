...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a bugna
...
// NewMsgDoneBlocksWithTrustedData returns a new bugna DoneBlocksWithTrustedData message that conforms to the
// Message interface.
