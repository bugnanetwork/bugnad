...
// MsgRequestTransactions implements the Message interface and represents a bugna
...
// NewMsgRequestTransactions returns a new bugna RequestTransactions message that conforms to
