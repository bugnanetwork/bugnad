...
// MsgDoneHeaders implements the Message interface and represents a bugna
...
// NewMsgDoneHeaders returns a new bugna DoneIBDBlocks message that conforms to the
// Message interface.
