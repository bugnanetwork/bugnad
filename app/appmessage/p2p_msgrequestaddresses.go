...
// MsgRequestAddresses implements the Message interface and represents a bugna
...
// NewMsgRequestAddresses returns a new bugna RequestAddresses message that conforms to the
