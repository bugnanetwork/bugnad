...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a bugna
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new bugna RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
