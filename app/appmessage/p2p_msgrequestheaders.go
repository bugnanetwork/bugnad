...
// MsgRequestHeaders implements the Message interface and represents a bugna
...
// NewMsgRequstHeaders returns a new bugna RequestHeaders message that conforms to the
