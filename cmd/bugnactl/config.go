...
type configFlags struct {
	...
	AllowConnectionToDifferentVersions bool   `short:"a" long:"allow-connection-to-different-versions" description:"Allow connections to versions different than bugnactl's version'"`
...
func parseConfig() (*configFlags, error) {
	...
	parser.Usage = "bugnactl [OPTIONS] [COMMAND] [COMMAND PARAMETERS].\n\nCommand can be supplied only if --json is not used." +
		"\n\nUse `bugnactl --list-commands` to get a list of all commands and their parameters." +
